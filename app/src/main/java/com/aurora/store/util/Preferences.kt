...
object Preferences {
    ...
    const val PREFERENCE_INSTALLATION_DEVICE_OWNER_MANAGE =
        "PREFERENCE_INSTALLATION_DEVICE_OWNER_MANAGE"

    const val PREFERENCE_DEVICE_OWNER_SOURCE = "PREFERENCE_DEVICE_OWNER_SOURCE"
    const val PREFERENCE_DEVICE_OWNER_RECEIVED = "PREFERENCE_DEVICE_OWNER_RECEIVED"
    const val PREFERENCE_DEVICE_OWNER_REFUSED = "PREFERENCE_DEVICE_OWNER_REFUSED"
    const val PREFERENCE_DEVICE_OWNER_LAST_OWNER = "PREFERENCE_DEVICE_OWNER_LAST_OWNER"
    const val PREFERENCE_DEVICE_OWNER_GLOBAL_LOCK = "PREFERENCE_DEVICE_OWNER_GLOBAL_LOCK"
    ...
    const val PREFERENCE_UPDATES_LAST_CHECK = "PREFERENCE_UPDATES_LAST_CHECK"
